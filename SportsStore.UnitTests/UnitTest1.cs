...
namespace SportsStore.UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public void Can_Generate_Page_Links()
        {
            ...
            Assert.AreEqual(@"<a class=""btn btn-default"" href=""Page1"">1</a>" + @"<a class=""btn btn-default selected btn-primary"" href=""Page2"">2</a>" + @"<a class=""btn btn-default"" href=""Page3"">3</a>", result.ToString());
        }
